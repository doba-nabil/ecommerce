    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">اضافة عملة جديدة</div>
                    ...
                    <form method="post" action="{{ route('currencies.store') }}">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="name_ar" name="name_ar" value="{{ old('name_ar') }}" required placeholder="اسم العملة باللغة العربية">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="name_en" name="name_en" value="{{ old('name_en') }}" required placeholder="اسم العملة باللغة الانجليزية">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
