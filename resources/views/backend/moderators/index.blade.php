        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">جميع المشرفين</div>
                    <form action="{{ route('moderators.show', 1) }}" method="get">
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-hover display table-striped table-bordered table-hover pb-30" >
                                    ...
                                    @foreach ($moderators as $moderator)
                                        <tr class="odd gradeX">
                                            <td><input value="{{ $moderator->id }}" type="checkbox" name="select[]"></td>
                                            ...
                                            <td>
                                                <ul class="list-inline list-unstyled text-center">
                                                    <li>
                                                        <a href="{{ route('moderators.edit',$moderator->id) }}" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="تعديل" style="padding: 8px 12px;"><i class="zmdi zmdi-edit"></i></a>
                                                    </li>
                                                    <li>
                                                        <form method="post" action="{{ route('moderators.destroy',$moderator->id) }}">
                                                            {{ csrf_field() }}
                                                            {{ method_field('DELETE') }}
