        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">جميع المدن</div>
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-hover display table-striped table-bordered table-hover pb-30" >
                                    ...
                                    @foreach ($cities as $city)
                                        <tr class="odd gradeX">
                                            <td><input value="{{ $city->id }}" type="checkbox" name="select[]"></td>
                                            <td>{{ $city->name_ar }}</td>
                                            <td>{{ $city->name_en }}</td>
                                            <td><a href="{{ route('countries.edit', $city->country->id) }}">{{ $city->country->name_ar }}</a></td>
                                            <td>
                                                <ul class="list-inline list-unstyled text-center">
                                                    <li>
                                                        <a href="{{ route('cities.edit', $city->id) }}" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="تعديل" style="padding: 8px 12px;"><i class="zmdi zmdi-edit"></i></a>
                                                    </li>
                                                    <li>
