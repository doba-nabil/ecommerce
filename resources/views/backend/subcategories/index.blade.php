        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <form action="{{ route('subcategories.show', 1) }}" method="get">
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-hover display table-striped table-bordered table-hover pb-30" >
                                    ...
                                    @foreach ($subcategories as $subcategory)
                                        <tr class="odd gradeX">
                                            <td><input value="{{ $subcategory->id }}" type="checkbox" name="select[]"></td>
                                            <td>{{ $subcategory->name_ar }}</td>
                                            <td>{{ $subcategory->name_en }}</td>
                                            <td><a href="{{ route('categories.edit', $subcategory->category->id) }}">{{ $subcategory->category->name_ar }}</a></td>
                                            <td>
                                                <ul class="list-inline list-unstyled text-center">
                                                    <li>
                                                        <a href="{{ route('subcategories.edit', $subcategory->id) }}" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="تعديل" style="padding: 8px 12px;"><i class="zmdi zmdi-edit"></i></a>
                                                    </li>
                                                    <li>
